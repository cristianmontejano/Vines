...
public class Game extends JPanel implements Runnable, KeyListener 
{
	...
	public void paintComponent(Graphics g)
	{
		...
		g.drawImage(new ImageIcon("grapes.png").getImage(),guy.getX(),guy.getY(),40,40,null);
		//guy2
		g.drawImage(new ImageIcon("melon.png").getImage(),guy2.getX(),guy2.getY(),40,40,null);
		
		g.setColor(Color.yellow);
		
		for(Tail t : guy.getTail())
			g.drawImage(new ImageIcon("vinetexture.png").getImage(),t.getX(),t.getY(),25,25,null);
